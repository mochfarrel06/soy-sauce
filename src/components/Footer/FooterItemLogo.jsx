  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-4">
        <h4 className="font-semibold text-base text-secondary tracking-wide sm:text-lg">
          Kecap Sawi
        </h4>
        <p className="font-normal text-sm text-gray2 tracking-wide sm:text-base md:w-3/4">
          Jln Mataram No 178, Karangrejo , Kecamatan Ngasem,Kabupaten
          Kediri,Jawa Timur 64181, Indonesia
        </p>
      </div>
